            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {tasksByCategory.map(group => (
                  ...
                  >
                    <TaskCategoryBadge category={group.category} className="!p-0 !bg-transparent !border-0" />
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {tasksByDifficulty.map(group => (
                  ...
                  >
                    <DifficultyBadge difficulty={group.difficulty as any} className="!p-0 !bg-transparent !border-0" />
                    <span className="ml-1">({group.tasks.length})</span>
                  </Badge>
                ))}
              </div>
                  ...
                  <CardHeader className="py-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <TaskCategoryBadge category={group.category} />
                        <span className="font-medium text-sm">
                          {group.category.charAt(0).toUpperCase() + group.category.slice(1)}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-xs text-gray-600">
                        <span>{group.tasks.length} tarefa{group.tasks.length !== 1 ? 's' : ''}</span>
                  ...
                  <CardHeader className="py-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <DifficultyBadge difficulty={group.difficulty as any} />
                        <span className="font-medium text-sm">
